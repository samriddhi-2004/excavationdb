import { c as createLucideIcon, j as jsxRuntimeExports, a as cn, r as reactExports, d as BookOpen, C as ChevronDown } from "./index-BUl89JH6.js";
import { B as Badge } from "./badge-DmeArO5X.js";
import { R as RESEARCH_PAPERS } from "./data-DBpipvIs.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-full flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border/30 bg-muted/20 px-6 py-1.5 flex items-center gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[10px] text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: RESEARCH_PAPERS.length }),
        " ",
        "total papers"
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[10px] text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: cn(
              "font-semibold",
              filtered.length < RESEARCH_PAPERS.length ? "text-primary" : "text-foreground"
            ),
...
function DetailPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 border-l border-border/30 pl-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] uppercase tracking-widest text-primary/70 mb-1", children: "Soil Parameters" }),
      ...
      paper.doiLink && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] uppercase tracking-widest text-primary/70 mb-1", children: "DOI" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: paper.doiLink,
