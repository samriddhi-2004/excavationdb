...
function parseCostMin(s2) {
  const m2 = s2.match(/(\d[\d,]*)/);
  return m2 ? Number.parseInt(m2[1].replace(",", ""), 10) : 0;
}
function parseCostMax(s2) {
...
function exportCSV(metrics, selectedSystems, selectedRows) {
  ...
  const a2 = document.createElement("a");
  a2.href = url;
  a2.download = "excavation-comparison.csv";
  a2.click();
  URL.revokeObjectURL(url);
}
...
function FilterPanel({
  ...
  const inner = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: "Wall Systems" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: ALL_SYSTEM_IDS.map((id) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "label",
        {
          htmlFor: `sys-cb-${id}`,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden border border-border/40 rounded-md bg-card mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2 font-mono text-xs uppercase tracking-wider text-foreground", children: [
      ...
      mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-4 border-t border-border/40 pt-3", children: inner })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "aside",
      {
...
function SortIcon({
  ...
  if (sortKey !== k2)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronsUpDown, { className: "w-3 h-3 text-primary/50" });
  if (sortDir === "asc") return /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-3 h-3" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3 h-3" });
}
...
function MaxHeightChart({
  ...
  const data = metrics.filter((m2) => selectedSystems.includes(m2.systemId)).map((m2) => ({
    name: SYSTEM_NAME[m2.systemId] ?? m2.systemId,
    maxHeight: m2.maxHeight,
    fill: SYSTEM_COLOR[m2.systemId]
  }));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      className: "rounded-md border border-border/40 bg-card p-4",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] uppercase tracking-widest text-primary mb-3", children: "Max Retained Height (m)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          BarChart,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "maxHeight", radius: [3, 3, 0, 0], children: data.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.fill }, entry.name)) })
            ]
          }
        ) })
      ]
...
function CostRangeChart({
  ...
  const data = metrics.filter((m2) => selectedSystems.includes(m2.systemId)).map((m2) => ({
    name: SYSTEM_NAME[m2.systemId] ?? m2.systemId,
    costMin: parseCostMin(m2.costRange),
    costMax: parseCostMax(m2.costRange),
    fill: SYSTEM_COLOR[m2.systemId]
  }));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
            ...
            children: [
                ...
                Legend,
                {
                  formatter: (value) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      children: value === "costMin" ? "Min" : "Max"
                    }
                  )
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Bar,
                {
                  ...
                  radius: [2, 2, 0, 0],
                  opacity: 0.55,
                  children: data.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.fill }, `min-${entry.name}`))
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "costMax", name: "costMax", radius: [3, 3, 0, 0], children: data.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.fill }, `max-${entry.name}`)) })
            ]
          }
        ) })
      ]
...
function WaterControlChart({
  ...
  const data = metrics.filter((m2) => selectedSystems.includes(m2.systemId)).map((m2) => ({
    name: SYSTEM_NAME[m2.systemId] ?? m2.systemId,
    waterScore: WATER_SCORE[m2.waterControl] ?? 0,
    fill: SYSTEM_COLOR[m2.systemId]
  }));
  const WATER_LABELS = {
    1: "Poor",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      className: "rounded-md border border-border/40 bg-card p-4",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] uppercase tracking-widest text-primary mb-3", children: "Water Control Score" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          BarChart,
          {
            data,
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                YAxis,
                {
                  domain: [0, 4],
                  ticks: [1, 1.5, 2, 3, 4],
                  tickFormatter: (v2) => WATER_LABELS[v2] ?? "",
                  tick: {
                    fill: "hsl(var(--muted-foreground))",
                    fontSize: 9,
                    fontFamily: "var(--font-mono)"
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  contentStyle: CHART_TOOLTIP_STYLE,
                  formatter: (v2) => [WATER_LABELS[v2] ?? v2, "Water Control"],
                  cursor: { fill: "hsl(var(--primary) / 0.07)" }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "waterScore", radius: [3, 3, 0, 0], children: data.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.fill }, entry.name)) })
            ]
          }
        ) })
      ]
                ...
                Legend,
                {
                  formatter: (value) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      children: SYSTEM_NAME[value] ?? value
                    }
                  )
                }
              ),
              filteredMetrics.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Line,
                {
                  type: "monotone",
                  dataKey: m2.systemId,
                  stroke: SYSTEM_COLOR[m2.systemId],
                  strokeWidth: 2,
                  dot: { r: 3, fill: SYSTEM_COLOR[m2.systemId] },
                  connectNulls: false
                },
                m2.systemId
              ))
...
function Comparison() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border/40 bg-card px-6 py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GitCompareArrows, { className: "w-4 h-4 text-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-widest text-primary", children: "Analysis" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground", children: "System Comparison" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Filter, sort, and chart all 6 excavation systems side-by-side." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-1 flex-shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Badge,
          {
            variant: "outline",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 lg:px-6 py-6 flex gap-6 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FilterPanel,
        {
          selectedSystems,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "comparison.table.section", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "comparison.charts.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-4 h-4 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-sm text-foreground", children: "Visual Comparison" })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-ocid": "comparison.insights.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/40 pt-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-widest text-primary", children: "Engineering Insights" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3", children: INSIGHTS.map((insight, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] uppercase tracking-wider text-muted-foreground", children: insight.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm text-primary mt-1", children: insight.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1 leading-relaxed", children: insight.note })
              ]
            },
            insight.title
          )) })
