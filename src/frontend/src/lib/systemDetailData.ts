// Rich structured data for each system's 8-tab content
// Kept separate from data.ts to avoid bloat
...
export interface SafetyFactorRow {
  checkType: string;
  minFS: string;
  basis: string;
}
...
export interface RichSystemDetail {
  basic: {
    description: string;
    useCases: string[];
    dimensions: DimRow[];
  ...
  earthPressure: {
    rankine: FormulaEntry[];
    coulomb: FormulaEntry[];
    notes: string;
  };
  fem: {
    approach: string;
    meshParams: string[];
    software: FemSoftware[];
  };
  parameterEffects: {
...
// ─── Shared FEM software table (reused across systems) ────────────────────

const COMMON_FEM_SOFTWARE: FemSoftware[] = [
  {
    tool: "Plaxis 2D/3D",
    ...
    elements: [
      {
        ...
        description:
          "Primary load-carrying vertical element. Resists active earth pressure via bending and embedment below excavation. Typical section modulus Sx = 500–2000 cm³. Piles are driven to refusal or drilled and grouted.",
      },
      {
        name: "Horizontal Lagging",
        description:
          "Spans between H-piles to transfer soil arching pressure. Installed progressively as excavation proceeds. For permanent walls, precast concrete panels replace timber for durability.",
      },
      {
        name: "Waling Beam",
        description:
          "Horizontal stiffener connecting pile heads or anchor connection points. Distributes concentrated anchor forces into the pile flange. Designed as a continuous beam on pile supports.",
      },
      {
        name: "Tie-back Anchor (Ground Anchor)",
        description:
          "Post-tensioned anchors drilled through the retained soil mass at 15–30° inclination. Bond zone in competent stratum beyond failure plane. Stressing load typically 1.25× design load per FHWA.",
      },
      {
        name: "Raker / Strut",
        description:
          "Inclined steel rakers (W200 sections) or horizontal cross-lot struts used when tie-backs are impractical. Rakers bear against a reinforced concrete kicker pad at excavation base.",
      },
    ],
  },
  soil: {
    applicability:
      "Best suited to stiff-to-hard clays (cu > 50 kPa), medium-dense to dense sands (Dr > 50%), and gravels. Not suitable for very soft clays (cu < 25 kPa), running sands below the water table, or sites requiring positive groundwater cut-off. Soil arching between piles is critical; minimum required arching ratio α ≥ 0.4.",
    parameters: [
      {
        ...
        unit: "°",
        effect:
          "Controls Ka and Kp; higher φ reduces active pressure by ~10–20%",
      },
      {
      ...
      },
      {
        ...
        unit: "kN/m³",
        effect:
          "Directly scales earth pressure; dense soils increase lateral force",
      },
      {
        ...
        unit: "MPa",
        effect:
          "Governs pile deflection and soil spring stiffness in p-y analysis",
      },
      {
      ...
      },
      {
        ...
        unit: "—",
        effect:
          "Reduces active pressure on lagging vs. full active; depends on s/D ratio",
      },
    ],
  },
  earthPressure: {
    ...
    cases: [
      {
        ...
        outcome:
          "Maximum deflection 38 mm; wall performed within 1.5× design prediction",
      },
      {
        ...
        outcome:
          "Deflection 22 mm; zero ground settlement beyond 5 m from wall",
      },
      {
        ...
        outcome:
          "Fast installation (3 weeks); slight seepage through lagging controlled with drainage",
      },
      {
...
const secantPile: RichSystemDetail = {
    ...
    elements: [
      {
        ...
        description:
          "Unreinforced concrete pile installed first. Softer C12/15 mix allows secondary pile coring to cut through the overlap zone cleanly. Centre-to-centre spacing equals sum of average radii.",
      },
      {
        name: "Secondary (King) Pile",
        description:
          "Reinforced concrete pile drilled through the hardened overlap of adjacent primaries. Houses the full structural reinforcement cage. Transfers all bending moment, shear, and axial force.",
      },
      {
        name: "Overlap Zone",
        description:
          "The interlocking region (20–75 mm each side) provides the primary water cut-off path. Verticality tolerances ≤ 1:100 are critical to maintain the minimum 20 mm overlap at pile toe.",
      },
      {
        name: "Capping Beam",
        description:
          "Continuous RC beam cast over all secondary pile heads. Distributes prop/anchor loads, ties wall together, and provides a platform for temporary propping systems.",
      },
      {
        name: "Temporary Steel Casing",
        description:
          "Oscillator or rotary casing prevents borehole collapse, especially critical when penetrating soft soils or granular materials above groundwater table.",
      },
    ],
  },
  soil: {
    applicability:
      "Performs in virtually all ground types: soft to stiff clay, loose to dense sand, gravel, fill, and weak rock. The continuous wall geometry and overlapping piles provide effective water control in soils with hydraulic conductivity up to k = 10⁻⁴ m/s. Particularly effective in variable urban fill, mixed ground, and high groundwater conditions.",
    parameters: [
      {
        parameter: "Friction angle (φ)",
        range: "25–42",
        unit: "°",
        effect:
          "Active/passive coefficients; higher φ reduces required embedment depth",
      },
      {
        parameter: "Cohesion (c)",
        range: "0–80",
        unit: "kPa",
        effect:
          "Provides wall toe stability in clay; reduces net active thrust",
      },
      {
        parameter: "Unit weight (γ)",
        range: "16–22",
        unit: "kN/m³",
        effect:
          "Scales earth pressure linearly; saturated soils add hydrostatic component",
      },
      {
        parameter: "Elastic modulus (E)",
        range: "10–200",
      ...
      },
      {
        ...
        unit: "m/s",
        effect:
          "Determines inflow rate at pile overlaps; watertight if k < 10⁻⁷ m/s",
      },
    ],
  },
  earthPressure: {
  ...
  design: {
    guidelines:
      "Pile diameter selection: typically 600–900 mm primary, 750–1050 mm secondary. Required overlap ≥ 20 mm per side, accounting for ≤1° verticality tolerance. Wall thickness equivalent to secondary pile diameter. Propping levels spaced ≤ 4 m vertically. Minimum embedment: D = H/3 in dense sand; D = H/2 in soft clay. FEM analysis mandatory for excavations > 10 m depth adjacent to sensitive structures.",
    safetyFactors: [
      {
  ...
  caseStudies: {
    cases: [
      ...
      },
      {
        ...
        outcome:
          "Basal heave FS = 1.65; instrumented monitoring within alert levels",
      },
      {
      ...
      },
      {
        ...
        outcome:
          "Construction completed 2 weeks ahead of schedule; δmax = 12 mm",
      },
    ],
  },
};
    ...
    elements: [
      {
        ...
        description:
          "The primary water-retaining and earth-retaining element. AZ double-U sections provide high section modulus per metre run. HZ-M combined sections add king piles for maximum moment capacity in heavy marine applications.",
      },
      {
        name: "Clutch / Interlock",
        description:
          "Interlocking mechanism between adjacent sheets. Ball-and-socket (Larssen) allows angular tolerance during driving. Sealant (hydrophilic rope or bituminous compound) is injected post-installation to minimise seepage.",
      },
      {
        name: "Waling Beam",
        description:
          "Continuous horizontal member connecting sheet pile heads at anchor level. Distributes tie-rod point loads into distributed sheet pile bending. Designed as a continuous beam on flexible supports.",
      },
      {
        name: "Tie-rod / Ground Anchor",
        description:
          "High-tensile steel rod connecting waling to a deadman anchor or grouted ground anchor behind the active failure plane. Pre-stressed to 10–20% of design load to prevent slack accumulation.",
      },
      {
        name: "Deadman Anchor",
        description:
          "Buried RC or steel plate anchor positioned at least 1.5× failure plane depth behind the wall. Resists pull-out via passive soil resistance. Check for corrosion in marine applications.",
      },
    ],
  },
  soil: {
    applicability:
      "Applicable in sands, gravels, soft to stiff clays, silts, and organic soils. Refusal risk in dense gravel, cobbles, or rock. Pre-drilling or water-jetting may be required in hard strata. Vibratory hammer effective in loose sand and soft clay (SPT N < 30). Impact hammer needed for dense gravel and stiff clay (SPT N > 30). Not suitable for hard rock without pre-drilling.",
    parameters: [
      {
        parameter: "Friction angle (φ)",
        range: "25–40",
    ...
    cases: [
      {
        ...
        outcome:
          "50-yr design life with cathodic protection; max deflection 28 mm",
      },
      {
        ...
        outcome:
          "Installed by vibro-hammer in 4 weeks; δmax = 45 mm at low tide",
      },
      {
        ...
        outcome:
          "Withstood Hurricane Katrina 2005; subsequent deepening to 9 m",
      },
      {
        ...
        outcome:
          "δmax = 35 mm; long-term tidal monitoring shows stable performance",
      },
    ],
  },
};
    ...
    elements: [
      {
        ...
        description:
          "All piles are identical: same diameter, same concrete mix, same reinforcement. Bored by rotary rig; temporary casing used in loose or water-bearing strata. Cast using tremie pipe from bottom up.",
      },
      {
        name: "Capping Beam",
        description:
          "Continuous RC beam over all pile heads. Connects pile tops and provides load distribution for props or anchors. Typically 400 mm wide × 500 mm deep; set in permanent formwork against excavation face.",
      },
      {
        name: "Geocomposite Drain",
        description:
          "Vertical drain sheet installed between pile face and permanent RC wall lining (if used). Routes groundwater infiltration through pile gaps to collection pipe at base, preventing hydrostatic buildup.",
      },
      {
        name: "Temporary Casing",
        description:
          "Steel temporary casing prevents borehole collapse above groundwater. Extracted during concrete pour (wet method) or left in place in unstable ground.",
      },
      {
        name: "Gap Grouting / Sealing",
        description:
          "When watertight performance is required, gaps between tangent piles are sealed post-installation by pressure grouting or bentonite injection. This upgrades the system toward near-secant performance.",
      },
    ],
  },
  soil: {
    applicability:
      "Best in stiff to hard clays (cu > 50 kPa), medium-dense to dense sands (Dr > 50%), and gravels. Adequate in medium-stiff clay with controlled dewatering. Not suitable in very soft clay, running sand, or conditions requiring positive watertight cut-off without gap grouting. Pile verticality tolerance ≤ 0.5° is critical to prevent gap opening at depth.",
    parameters: [
      {
        parameter: "Friction angle (φ)",
        range: "28–40",
      ...
      },
      {
        ...
        unit: "kPa",
        effect:
          "Reduces net active thrust; controls gap stability between piles",
      },
      {
        parameter: "Unit weight (γ)",
        range: "17–21",
      ...
      },
      {
        ...
        unit: "MPa",
        effect:
          "Governs wall deflection; critical near sensitive adjacent structures",
      },
      {
        parameter: "Poisson's ratio (ν)",
        range: "0.22–0.35",
        unit: "—",
        effect:
          "Affects K0 calculation for at-rest pressure on permanent walls",
      },
      {
        parameter: "SPT N-value",
        range: "10–60+",
        unit: "blows/300mm",
        effect:
          "N > 10 ensures borehole stability; N > 30 for anchorage capacity",
      },
    ],
  },
  earthPressure: {
  ...
  caseStudies: {
    cases: [
      ...
      },
      {
        ...
        outcome:
          "3-week installation; δmax = 22 mm; seepage grouted post-construction",
      },
    ],
  },
};
...
const micropile: RichSystemDetail = {
  basic: {
    description:
    ...
    dimensions: [
      ...
      },
      {
        ...
        unit: "°",
        notes:
          "Vertical or inclined; pairs at ±15° common for lateral resistance",
      },
      {
    ...
    elements: [
      {
        ...
        description:
          "Remains in place as structural element. Carries tension, compression, and lateral load via composite action with grout. Wall thickness 6–12 mm. Grade T91 for highest capacity applications.",
      },
      {
        name: "Central Reinforcing Bar",
        description:
          "Threaded high-tensile bar (Williams Grade 150 or Dywidag Grade 835) provides redundancy and additional tensile capacity. Can be post-tensioned to pre-load the system against expected lateral drift.",
      },
      {
        name: "Cement Grout (Bond Zone)",
        description:
          "Transfers load from steel tube to surrounding soil/rock via skin friction. Bond length typically 5–10 m in competent soil. TAM sleeve-port grouting (Types C/D) re-groutes after casing installation, compacting surrounding soil and increasing bond stress by 40–80%.",
      },
      {
        name: "Capping Beam",
        description:
          "Ties all micropile heads together to distribute lateral earth pressure and provide global wall system action. For inclined pile pairs, the capping beam resists the resultant horizontal force from pile pair geometry.",
      },
      {
        name: "Lagging (if applicable)",
        description:
          "In some micropile wall configurations, small concrete panels or shotcrete is applied between piles to retain soil between pile faces. For dense or stiff soils, soil arching can eliminate the need for lagging.",
      },
    ],
  },
  soil: {
    applicability:
      "Applicable in virtually all ground conditions: hard rock (RQD > 20%), gravel, sand, silt, clay, fill, and karst. Exceptionally suited for variable or unpredictable ground where conventional pile installation is risky. Minimum site clearance: 200 mm from existing structures. Minimum headroom: 2 m for standard rigs; 1.2 m for low-headroom specialist equipment.",
    parameters: [
      {
        ...
        unit: "MPa",
        effect:
          "Primary capacity driver; 3.5 MPa in rock, 0.25 MPa in sand, 0.15 MPa in clay",
      },
      {
        parameter: "Friction angle (φ)",
        range: "25–45",
        unit: "°",
        effect:
          "Lateral resistance of composite pile-soil; governs p-y curve in sand",
      },
      {
        parameter: "Cohesion (c)",
        range: "0–100",
      ...
      },
      {
        ...
        unit: "MPa",
        effect:
          "Soil stiffness for lateral deflection; rock modulus drives axial capacity",
      },
      {
        parameter: "RQD (rock)",
        range: "20–100",
      ...
      },
      {
        ...
        unit: "blows/300mm",
        effect:
          "Governs grout bond stress in sands; N > 30 allows reduced bond length",
      },
    ],
  },
  earthPressure: {
    rankine: [
      {
        label:
          "Lateral earth pressure per micropile (tributary width = pile spacing)",
        formula:
          "H_per_pile = Ka · γ · z · s\n\nWhere:\n  s = pile spacing (m)\n  z = depth (m)\n  Ka = tan²(45° − φ/2)",
  ...
  fem: {
    ...
    software: [
      ...COMMON_FEM_SOFTWARE,
      {
        ...
        application:
          "Lateral loading of individual micropiles, p-y calibration",
      },
      {
        tool: "FB-Multipier",
        type: "3D pile group",
        application:
          "Group effect correction for closely-spaced micropile arrays",
      },
    ],
  },
  parameterEffects: {
  ...
  design: {
    guidelines:
      "Drill diameter selection: 100–200 mm for retaining, 75–150 mm for underpinning. Pile capacity governed by grout-soil bond length (Type B/C grouting maximises qs). For lateral loading, p-y curves from LPILE govern pile head deflection. Inclined pile pairs (±15°) provide 2–3× lateral resistance vs. vertical piles for same number. Global stability: check as gravity wall (weight of soil + piles) against overturning and sliding.",
    safetyFactors: [
      {
    ...
    cases: [
      {
        ...
        outcome:
          "Zero damage to adjacent Colosseum; δmax = 4 mm during excavation",
      },
      {
        ...
        outcome:
          "Lateral capacity 3× pre-retrofit; wall surviving design earthquake (0.5g)",
      },
      {
        ...
        outcome:
          "Installed under live rail track; max train vibration 1.8 mm/s ppv",
      },
      {
        ...
        outcome:
          "Slope stabilised; 22-year monitoring shows <2 mm annual creep",
      },
    ],
  },
};
    ...
    elements: [
      {
        name: "Guide Walls",
        description:
          "Twin RC beams set at ground level defining the trench line. Maintain trench mouth geometry, support slurry head, act as working platform. Typically 1.5 m deep, 300 mm thick per wall, spanning between panel bites.",
      },
      {
        name: "Bentonite / Polymer Slurry",
        description:
          "Keeps trench open by providing hydrostatic support to trench walls. Bentonite: 4–7% concentration forms filter cake. Polymer slurry (biodegradable): no filter cake, faster concrete cleaning, better bond in rock. Slurry density checked every 4 hours.",
      },
      {
        name: "Reinforcement Cage",
        description:
          "Pre-assembled in sections, lowered into slurry-filled trench. Typically 2-layer with T25–T32 bars at 100–150 mm centres. Spacers maintain 40–80 mm cover. Crane capacity governs maximum cage weight and panel depth.",
      },
      {
        name: "Panel Joints (Stop-Ends)",
        description:
          "CWS (circular water-stop) or H-beam defines panel-to-panel joints. HDPE water-stop cast in provides primary water seal. Joint quality is critical for watertightness; defect detection by core drilling or sonic logging.",
      },
      {
        name: "Tremie Concrete",
        description:
          "Self-compacting concrete poured from bottom of trench upward through tremie pipe, displacing bentonite. Continuous pour without interruption. Tremie kept submerged ≥ 2 m in fresh concrete throughout.",
      },
    ],
  },
  soil: {
    applicability:
      "Applicable in all soil types. Favoured in soft-to-firm clay, dense sand, stiff clay, and hard rock (requires hydraulic mill). Bentonite slurry stabilises trench in any soil. Critical: trench stability check Ftrench = (ρs − ρw)/(Ka · γ − ρslurry) ≥ 1.1. Silts and fine sands require elevated slurry density. Deep soft clay: basal heave critical (Nb = 5.14·cu/q ≥ 1.2).",
    parameters: [
      {
        parameter: "Friction angle (φ)",
        range: "20–42",
        unit: "°",
        effect:
          "Active/passive pressures; Kp critical for toe stability at depth",
      },
      {
        parameter: "Cohesion (c)",
        range: "0–100",
      ...
      },
      {
        ...
        unit: "kN/m³",
        effect:
          "Scales earth and slurry pressure; saturated soft clay is critical",
      },
      {
        parameter: "Elastic modulus (E)",
        range: "5–200",
        unit: "MPa",
        effect:
          "Controls wall deflection; small strain E₀ important for settlement prediction",
      },
      {
      ...
      },
      {
        ...
        unit: "MPa",
        effect:
          "Required for HS-Small model; governs settlement prediction accuracy",
      },
    ],
  },
  earthPressure: {
    ...
    cases: [
      {
        ...
        outcome:
          "Max deflection 22 mm; adjacent Central Line tunnels within 3 mm settlement",
      },
      {
        ...
        outcome:
          "Basal heave FS=1.6; max wall deflection 38 mm; real-time monitoring",
      },
      {
        ...
        outcome:
          "Max settlement 8 mm at surface; Louvre museum adjacent undisturbed",
      },
      {
        ...
        outcome:
          "Basal heave near critical (FS=1.25); pre-consolidation grouting improved FS to 1.6",
      },
    ],
  },
};
...
export const SYSTEM_DETAILS_RICH = new Map<string, RichSystemDetail>([
